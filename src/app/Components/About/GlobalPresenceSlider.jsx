    ...
    return (
        <section className="bg-black 2xl:py-12 py-10">
            <div className="container mx-auto">
                <h2 className="text-[#ED1E3A]xl lg:text-4xl 2xl:text-5xl font-bold mb-8 text-center text-white">Our Global Presence</h2>
                    ...
                    {locations.map((location, index) => (
                        <SwiperSlide key={index}>
                            <div className="relative group rounded-lg overflow-hidden">
                                ...
                                <div className="absolute bottom-4 left-4 text-white font-black text-[#ED1E3A]xl lg:text-4xl 2xl:text-5xl group-hover:opacity-0 transition-opacity duration-300">
                                    {location.city}
                                </div>
                            </div>
                        </SwiperSlide>
