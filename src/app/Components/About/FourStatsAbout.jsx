      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="bg-gradient-to-r from-red-600 to-red-700 p-6 rounded-lg shadow-md text-center flex flex-col items-center">
            ...
            />
            <h3 className="text-2xl 2xl:text-[#ED1E3A] font-bold text-white">500+</h3>
          ...
          <div className="bg-gradient-to-r from-red-600 to-red-700 p-6 rounded-lg shadow-md text-center flex flex-col items-center">
            <img
              ...
              className="mx-auto mb-4 rounded-full object-cover"
            />
            <h3 className="text-2xl 2xl:text-[#ED1E3A] font-bold text-white">80+</h3>
          ...
          <div className="bg-gradient-to-r from-red-600 to-red-700 p-6 rounded-lg shadow-md text-center flex flex-col items-center">
            <img
              ...
              className="mx-auto mb-4 rounded-full object-cover"
            />
            <h3 className="text-2xl 2xl:text-[#ED1E3A] font-bold text-white">10+</h3>
          ...
          <div className="bg-gradient-to-r from-red-600 to-red-700 p-6 rounded-lg shadow-md text-center flex flex-col items-center">
            <img
              ...
              className="mx-auto mb-4 rounded-full object-cover"
            />
            <h3 className="text-2xl 2xl:text-[#ED1E3A] font-bold text-white">30+</h3>
