  ...
  const accordionData = [
    {
      ...
      content:
        "We focus on both great looks and functionality, creating websites that are visually appealing and user-friendly. Our designs are crafted to enhance user experience and performance.",
    },
    {
      title: "Why choose our web design Dubai team?",
      content:
        "Our team is made up of experienced web designers who specialize in delivering bespoke designs tailored to your needs.",
    },
    {
      title: "How do we make your web designs effective?",
      content:
        "We ensure that every website is optimized for performance, accessibility, and SEO.",
    },
    {
      title: "What benefits can you get from our website design services?",
      content:
        "Our design services come with a range of benefits, from enhanced online presence to improved conversion rates.",
    },
  ];

  const [openIndex, setOpenIndex] = useState(null); // State to keep track of the open accordion
