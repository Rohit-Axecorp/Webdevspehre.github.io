            ...
            <div className="container 2xl:py-12 py-10">
                <div className="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div className="text-left md:w-1/2">
                        <h3 className="text-[#ED1E3A] lg:text-4xl 2xl:text-5xl font-bold"> <span className='text-[#ED1E3A]'> Celebrating Excellence </span> Awards that Reflect Our Credibility
                        </h3>
