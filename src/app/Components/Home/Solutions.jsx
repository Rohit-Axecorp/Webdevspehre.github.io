      ...
      <section className='bg-gray-100'>
        <div className="2xl:py-12 py-10 container ">
          <div className="text-center">
            <h3 className="text-[#ED1E3A] lg:text-4xl 2xl:text-5xl font-bold text-black mb-4"><span className='text-[#ED1E3A]'> Offering Versatile Web Solutions </span> Across Diverse Industries
            </h3>
