    ...
    return (
        <div className="fixed left-0 top-1/2 transform -translate-y-1/2 flex-col space-y-3 md:p-7 p-5 z-50 lg:block hidden">
            <a
                ...
                className="flex items-center justify-center text-white border-[1px] border-none rounded-full p-3 bg-red-600 bg-opacity-80 transition-transform transform hover:scale-110 hover:shadow-lg hover:bg-opacity-100 icon-animation"
            >
                <FaFacebookF size={25} />
            </a>
            <a
