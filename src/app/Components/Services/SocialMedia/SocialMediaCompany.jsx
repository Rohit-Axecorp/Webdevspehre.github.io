        ...
        <section className='bg-gray-100 py-6 md:py-12'> {/* Reduced padding for smaller screens */}
            <div className="container mx-auto flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-center p-4 md:p-8 lg:px-16"> {/* Reduced padding for smaller screens */}
                    <h2 className="text-3xl lg:text-4xl 2xl:text-5xl font-bold text-gray-800 mb-2"> {/* Adjusted text size */}
                    ...
                    <div className="flex items-center mt-4">
                        <span className="open-popup 2xl:text-lg lg:text-base text-sm font-semibold text-red-500 mr-2 cursor-pointer">WE CAN INCREASE YOUR LEADS AND SALES</span>
