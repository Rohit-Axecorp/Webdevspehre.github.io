          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 px-6">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between h-[600px] overflow-y-auto border-x-4 border-[#ED1E3A]">
              <div>
                ...
                <p className="mb-6 text-base sm:text-lg font-normal text-gray-600">
                  Perfect for small businesses in Dallas, this package offers all essential SEO services to help you establish and grow your online presence.
                </p>
              </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between h-[600px] overflow-y-auto border-x-4 border-[#ED1E3A]">
              <div>
                ...
                <p className="mb-6 text-base sm:text-lg font-normal text-gray-600">
                  Ideal for medium-sized Dallas businesses, this package offers targeted SEO and lead generation strategies to help you attract more clients locally.
                </p>
              </div>
              <a href="#" className="text-[#ED1E3A] hover:underline hover:text-red-600 font-semibold text-lg sm:text-xl">
                LET&apos;S GET STARTED
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between h-[600px] overflow-y-auto border-x-4 border-[#ED1E3A]">
              <div>
                ...
                <p className="mb-6 text-base sm:text-lg font-normal text-gray-600">
                  The ultimate package for large Dallas businesses, providing extensive SEO and lead generation tools to dominate the market.
                </p>
              </div>
              <a href="#" className="text-[#ED1E3A] hover:underline hover:text-red-600 font-semibold text-lg sm:text-xl">
                LET&apos;S GET STARTED
