  ...
  return (
    <>
      <div className="bg-gray-100 py-10">
        <h1 className="text-center font-semibold text-4xl pb-12">Chicago SEO Packages</h1>
        <div className="w-2/3 mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Box 1: Steady Growth */}
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
            <div>
              <div className="flex items-center mb-4">
                <FaRocket className="text-red-500 text-3xl mr-3" />
                <h2 className="text-2xl font-bold">Steady Growth</h2>
              </div>
              <ul className="list-disc list-inside mb-4 text-sm font-medium">
                <li>Basic package</li>
            ...
            <a href="#" className="text-red-500 hover:underline self-start text-base font-medium">Get Started</a>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
            <div>
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-2xl font-bold">Faster Growth</h2>
              </div>
              <ul className="list-disc list-inside mb-4 text-sm font-medium">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
            <div>
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-2xl font-bold">Full Speed Growth</h2>
              </div>
              <ul className="list-disc list-inside mb-4 text-sm font-medium">
