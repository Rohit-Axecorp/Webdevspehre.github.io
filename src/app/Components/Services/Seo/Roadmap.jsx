            ...
            <div className="container mx-auto text-center">
                ...
                <div className="relative flex items-center">
                    ...
                    <div className="absolute inset-0 flex items-center z-30 -mt-16">
                        <div className="w-5/6 mx-auto h-[2px] bg-gray-300"></div>
                    </div>
                    {/* Steps */}
                    {[...Array(5)].map((_, index) => (
                        <div key={index} className="flex flex-col items-center relative w-1/5">
                            <div className="text-9xl font-bold text-gray-200 relative z-10">{String(index + 1).padStart(2, '0')}</div>
                            ...
                            {/* Dot */}
                            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-red-500 rounded-full z-40 -mt-8"></div>
                        </div>
                    ))}
                </div>
            </div>
