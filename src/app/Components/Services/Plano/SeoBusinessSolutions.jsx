...
export default function SeoBusinessSolutions() {
    ...
    const images = [
        '/Images/best SEO Company Plano TX.png',
            ...
            <section className="py-12">
                <div className="flex flex-col md:flex-row p-6 container mx-auto md:gap-20 gap-5">
                    ...
                    <div className="md:w-1/2 flex flex-col justify-center p-4">
                        ...
                        <h2 className="text-3xl lg:text-4xl 2xl:text-5xl font-bold mb-4 text-[#ED1E3A]">We&apos;re the Top Choice As the Top SEO Company in Plano
                        </h2>
